...
def criar_prompt_modelo_ameacas(tipo_aplicacao, 
                                ...
                                dados_sensiveis, 
                                descricao_aplicacao):
    prompt = f"""Você é um especialista em cibersegurança com mais de 20 anos de experiência 
    utilizando a metodologia de modelagem de ameaças STRIDE para produzir modelos de ameaças 
    abrangentes para uma ampla gama de aplicações. Sua tarefa é analisar a arquitetura, descrições 
    e detalhes técnicos fornecidos para produzir uma lista de ameaças específicas para essa
    aplicação.
...
async def analisar_ameacas(
    ...
    try:
        ...
        print(imagem)
        # Prompt para o modelo de ameaças
